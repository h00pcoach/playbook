		...
		<script type="text/javascript">
			$(function(){
				$('#payment_btn').click(function(){
					location.href = '../pay_test/pay.php?uid=<?=$uid?>&affiliate=<?=$affiliate?>&payment_type='+$('input[name=payment_type]:checked').val();
					return false;
				})
			})
		</script>
...
<div style="margin-left:75px;"><a href="../play.php"><u><i>Later</i></u></a> | Back to <a href="https://www.hoopcoach.org">HoopCoach.org</a></div>
