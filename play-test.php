...
<!DOCTYPE html>
	<head>
		...
		<script src="js/acetrik1b_test.js?version=1.2"></script>
		        	...
		        	<li id="actions" class="dropdown">
		          		...
		          		<div class="visible-xs-block">
			            	...
			            	<ul id="collapseMenu" class="collapse list-unstyled" aria-labelledby="dLabel">
				                ...
				                <li>
			                  		<a href="https://www.hoopcoach.org/playbook/premium/index.php" rel="nofollow" style="color:black;" id="logout_btn">Logout</a>
				                </li>
				            </ul>
		          		</div>
				        ...
				        <div class="col-xs-12 visible-xs-block">
					        ...
					        <div class="col-sm-12">
								<div class="pay_box" style="">
						          	...
						          	<?php if(isset($_SESSION['user_id']) && $result['paid']==0): ?>
							          <div style="font-weight:bold; font-size:135%; padding-left:5px; color:#0b5dad; text-align:center;">Get Playbook Pro!</div>
							          <div style="text-align:center;">
