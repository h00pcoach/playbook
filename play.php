	...
	<script type="text/javascript">
		...
		$(document).ready(function (e) {
			...
			user = {
				id: '<?php echo $result['
				id ']; ?>',
				lastname: '<?php echo $result['
				name ']; ?>',
				email: '<?php echo $result['
				email ']; ?>',
				ismale: '<?php echo $result['
				ismale ']; ?>',
				role: '<?php echo $result['
				role ']; ?>',
				profileurl: '<?php echo $result['
				hoopcoachpage ']; ?>',
				avatarurl: '<?php echo $result['
				avatar ']; ?>',
				hoopid: '<?php echo $result['
				hoopcoachid ']; ?>'
			};
...
<body>
	...
	<nav class="navbar" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#menu-nav" aria-expanded="false"
			...
			<div id="menu-nav" class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					<li>
						<a class="nav-link" href="https://www.hoopcoach.org/playbook/basketball-plays.php" target="_blank" style="color:black;">Plays
							Library</a>
					</li>

					<li>
						<a class="nav-link" href="https://www.hoopcoach.org/quick-tips-for-using-hoop-coach-playbook/" target="_blank"
						 style="color: black;">Quick Tips</a>
					</li>
					...
					<li id="actions" class="dropdown">
						<div class="hidden-xs visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">
							<a class="nav-link" id="menu-dd" data-target="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Menu
							...
							<ul class="dropdown-menu" aria-labelledby="menu-dd">
								...
								<li>
									<a class="pass78" href="https://www.hoopcoach.org/playbook/coach_set_password.php" rel="nofollow">Playbook
										Password</a>
								</li>
								<li>
								...
								<li>
									<a class="loginLog" href="https://www.hoopcoach.org/playbook/coach_student_tracking.php" rel="nofollow">Login
										Log</a>
								</li>
								<li>
						...
						<div class="visible-xs-block">
							<a class="nav-link" role="button" data-toggle="collapse" href="#collapseMenu" aria-expanded="false"
		...
		<div class="row game-row">
			...
			<div id="downloading-modal" class="modal" tabindex="-1" role="dialog">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<h4 style="text-align: center;">Your play is being exported. <br /> Based on the size of the play this could
								take a minute. <br /> <span class="glyphicon glyphicon-refresh glyphicon-refresh-animate" style="margin-top: 15px;"></span></h4>
						</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<a id="forgot_pass" class="pull-right" href="https://www.hoopcoach.org/playbook/pass/pass-support.php">forgot
									password?</a>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body" style="text-align: center;">
							...
							<a href="/playbook/premium/index.php?uid=<?= isset($_SESSION['user_id']) ? $_SESSION['user_id'] : '' ?>" target="_blank"
							 class="btn btn-success text-white">Upgrade Now</a>
						</div>
					</div><!-- /.modal-content -->
				</div><!-- /.modal-dialog -->
			</div><!-- /.modal -->
			...
			<div class="col-sm-12">
				<div class="pay_box" style="margin-top:10px;">
					...
					<div style="font-weight:bold; font-size:135%; padding-left:5px; color:#0000ff; text-align:center;">Get Playbook
						Pro!</div>
					<div style="text-align:center;">
						<a href="https://hoopcoach.org/playbook/premium/index.php?uid=<?= $_SESSION['user_id'] ?>"><img src="https://www.paypal.com/en_US/i/btn/btn_xpressCheckout.gif"
							 align="center" style="margin-right:7px;"></a>
					</div>
					<?php endif; ?>
					...
					<div style="font-weight:bold; font-size:135%; padding-left:5px; color:#0000ff; text-align:center;">Get Playbook
						Pro!</div>
					<div style="text-align:center;">
						<a href="https://hoopcoach.org/playbook/register.php?type=new"><img src="https://www.paypal.com/en_US/i/btn/btn_xpressCheckout.gif"
							 align="center" style="margin-right:7px;margin-top:-"></a>
					</div>
					<?php endif; ?>
				</div>
			...
			<div class="col-sm-6 court">
				...
				<div id="name-text" style="text-align:center">
					<?php echo $name; ?>&nbsp;</div>
				...
				<div class="col-xs-12 hidden-xs">
					<div class="bot col-sm-12">
						<ul id="rate-list" class="list-inline center-block" style="display: table;">
							<li style="display: table-cell; vertical-align: top; width: 100%;">Rate this play<div id="star"></div>
							</li>
						</ul>
					</div>
					...
					<div class="bot col-sm-12">
						<div>
							...
							<table style="margin-top:15px">
								<tr>
									<td colspan="6"><em>Playbook Tagging for Pro Users</em></td>
								</tr>
								<tr>
									...
									<td style="text-align: left">Scout: <br /><input name="scout" id="scout" class="form-control" style="width:100px;border-color: gray;"
										 value="<?php if (isset($res['scout'])) echo $res['scout']; ?>"></td>
									<td></td>
								</tr>
							</table>
						</div>
				...
				<div class="col-xs-12 tools-content center-block">
					...
					<div class="quickadd col-sm-offset-1 col-sm-6 tools-section tools-clip">
						...
						<div class="col-xs-6 col-sm-12 col-md-12 col-lg-6 quick" style="text-align: center;">
							<button id="autoadd" class="tool btn btn-default btn-pb center-block" data-target=".tools" data-element="#Player"
							 data-type="players"><span class="glyphicon glyphicon-plus"></span> 5 Offense</button>
						</div>

						<div class="col-xs-6 col-sm-12 col-md-12 col-lg-6 quick" style="text-align: center;">
							<button id="autoadd_def" class="tool btn btn-default btn-pb center-block" data-target=".tools" data-element="#Forward"
							 data-type="forwards"><span class="glyphicon glyphicon-plus"></span> 5 Defense</button>
						</div>
					</div>
					...
					<div id="court-objects" class="col-xs-12 tools-section">
						...
						<div id="offense-container" class="col-xs-6 col-sm-6 col-md-3 tools-section">
							...
							<div class="btn-group" id="Player">
								<button type="button" class="btn btn-default btn-pb dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
								 aria-expanded="false">
									Offense <span class="caret"></span>
								</button>
								<ul class="dropdown-menu list-inline" style="text-align:center;">
									<li> <img src="Model/Img/players/01.png" id="p1" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="125" data-y="353" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/02.png" id="p2" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="84" data-y="421" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/03.png" id="p3" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="186" data-y="410" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/04.png" id="p4" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="108" data-y="460" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/05.png" id="p5" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="176" data-y="463" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/06.png" id="p6" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="125" data-y="353" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/07.png" id="p7" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="84" data-y="421" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/08.png" id="p8" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="186" data-y="410" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/09.png" id="p9" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="108" data-y="460" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/10.png" id="p10" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="176" data-y="463" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/11.png" id="p11" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="125" data-y="353" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/12.png" id="p12" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="84" data-y="421" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/13.png" id="p13" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="186" data-y="410" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/14.png" id="p14" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="108" data-y="460" alt="Basketball Playbook Offense"> </li>
									<li> <img src="Model/Img/players/15.png" id="p15" class="ui-draggable clickable tool" data-category="Player"
										 data-target=".tools" data-x="176" data-y="463" alt="Basketball Playbook Offense"> </li>
								</ul>
							</div>
						...
						<div id="defense-container" class="col-xs-6 col-sm-6 col-md-3 tools-section">
							...
							<div class="btn-group" id="Forward">
								...
								<ul class="dropdown-menu list-inline" style="text-align:center;">
									<li> <img src="Model/Img/forwards/x1.png" id="x1" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="82" data-y="90" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x2.png" id="x2" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="90" data-y="82" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x3.png" id="x3" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="166" data-y="155" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x4.png" id="x4" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="240" data-y="169" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x5.png" id="x5" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="169" data-y="240" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x6.png" id="x6" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="82" data-y="90" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x7.png" id="x7" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="90" data-y="82" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x8.png" id="x8" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="166" data-y="155" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x9.png" id="x9" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="240" data-y="169" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x10.png" id="x10" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="169" data-y="240" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x11.png" id="x11" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="82" data-y="90" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x12.png" id="x12" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="90" data-y="82" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x13.png" id="x13" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="166" data-y="155" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x14.png" id="x14" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="240" data-y="169" alt="Basketball Playbook Defense"> </li>
									<li> <img src="Model/Img/forwards/x15.png" id="x15" class="ui-draggable clickable tool" data-category="Forward"
										 data-target=".tools" data-x="169" data-y="240" alt="Basketball Playbook Defense"> </li>
								</ul>
							</div>
						...
						<div id="ball-container" class="col-xs-6 col-sm-6 col-md-3 tools-section">
							...
							<div class="btn-group" id="Ball">
								...
								<ul class="dropdown-menu list-inline" style="text-align:center;">
									<li> <img src="Model/Img/balls/ball01.png" id="b0" data-category="Ball" class="ui-draggable ui-draggable-handle clickable tool" />
									</li>
									<li> <img src="Model/Img/balls/ball02.png" id="b1" data-category="Ball" class="ui-draggable ui-draggable-handle clickable tool" />
									</li>
									<li style="display: none"> <img src="Model/Img/balls/ball02.png" id="b2" data-category="Ball" class="ui-draggable ui-draggable-handle clickable tool" />
									</li>
								</ul>
							</div>
						...
						<div id="cone-container" class="col-xs-6 col-sm-6 col-md-3 tools-section">
							...
							<div class="btn-group" id="Cone">
								...
								<ul class="dropdown-menu list-inline" style="text-align:center;">
									<li> <img src="Model/Img/forwards/cone01.png" id="c1" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone02.png" id="c2" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone03.png" id="c3" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone04.png" id="c4" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone05.png" id="c5" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone06.png" id="c6" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone07.png" id="c7" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone08.png" id="c8" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone09.png" id="c9" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone10.png" id="c10" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone11.png" id="c11" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone12.png" id="c12" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone13.png" id="c13" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone14.png" id="c14" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
									<li> <img src="Model/Img/forwards/cone15.png" id="c15" class="ui-draggable clickable tool" data-category="Cone"
										 data-target=".tools" /> </li>
								</ul>
							</div>
						</div>
					...
					<div id="drawing_tools" class="col-sm-5 tools-section tools-clip">
						...
						<ul class="list-inline" style="text-align: center;">
							<li>
								<button id="wcut" class="btn btn-default btn-control center-block" onClick="return sline();"><img src="img/images/cut.png"
									 srcset="img/images/cut.png 2x" alt="Cut Playbook Tool"></button>
								cut
							</li>

							<li>
								<button id="wpass" class="btn btn-default btn-control center-block" onClick="return sline(true);"><img src="img/images/pass.png"
									 srcset="img/images/pass.png 2x" alt="Pass Playbook Tool"></button>
								pass
							</li>

							<li>
								<button id="wdribble" class="btn btn-default btn-control center-block" onClick="return sline(false,false,true);"><img
									 src="img/images/dribble.png" srcset="img/images/dribble.png 2x" alt="Dribble Playbook Tool"></button>
								dribble
							</li>

							<li>
								<button id="wscreen" class="btn btn-default btn-control center-block" onClick="return sline(false,true);"><img
									 src="img/images/screen.png" srcset="img/images/screen.png 2x" alt="Screen Playbook Tool"></button>
								screen
							</li>

							<li>
								<button id="wcurved" class="btn btn-default btn-control center-block" onClick="return s_pline();"><img src="img/images/curve.png"
									 srcset="img/images/curve.png 2x" alt="Curved Playbook Tool"></button>
								curved
							</li>
						</ul>
					</div>
					...
					<div class="col-xs-12 col-sm-offset-1 col-sm-6 tools-section tools-clip">
						...
						if (isset($_SESSION['user_id']) && $plays_count >= 5 && $result['paid'] == 0) {
							...
							<?php if (!$is_student) : ?>
							<li class="tool" data-target=".tools">
								<button id="save_btn" class="tool btn btn-default btn-pb btn-lg center-block" data-toggle=".tools" <?= $disabled
																																																																																																											? 'disabled' : '' ?>>
							...
							<li>
								<a href="#" class="copy_play_btn pro-button tool btn btn-default btn-pb btn-lg center-block" from-id="<?= $_REQUEST['id'] ?>"
								 to-user="<?= $_SESSION['user_id'] ?>"><span class="glyphicon glyphicon-duplicate"></span></a>
								Copy
							</li>
							<?php endif; ?>
						</ul>
						...
						<div class="col-sm-12">
							<div class="pay_box" style="">
								...
								<div style="font-weight:bold; font-size:135%; padding-left:5px; color:#0000ff; text-align:center;">Get Playbook
									Pro!</div>
								<div style="text-align:center;">
									<a href="/premium/index.php?uid=<?= $_SESSION['user_id'] ?>"><img src="https://www.paypal.com/en_US/i/btn/btn_xpressCheckout.gif"
										 align="center" style="margin-right:7px;"></a>
								</div>
								<?php endif; ?>
							...
							<div>Comment
								...
								<table style="margin-top:15px">
									...
									<tr>
										...
										<td style="text-align: left">Tags: <br /><input name="tags" type="text" id="tags-xs" class="form-control"
											 style="width:100px;border-color: gray;"></td>
										<!-- <td style="font-weight: bold;"></td> -->
										<td style="text-align: left">Scout: <br /><input name="scout" id="scout-xs" class="form-control" style="width:100px;border-color: gray;"
											 value="<?php if (isset($res['scout'])) echo $res['scout']; ?>"></td>
									</tr>
								</table>
							</div>
	...
	<div class="overlay container-fluid visible-xs-block" style="display: <?= $showOverlay ? 'block' : 'none!important' ?>">
		<div class="row">
			...
			<div class="col-xs-6" style="text-align: right; height: 50vh; padding-right: 0;">
				<img src="img/scroll_overlay.png" srcset="img/scroll_overlay@2x.png 2x" alt="basketball playbook plays" class="pull-right"
		...
		$('.copy_play_btn').click(function () {
			...
			$.post('copy_play.php', {
				...
				if (typeof (data.data_res) != "undefined") {
					...
					$('#copy-play-modal .modal-body').html(data.msg + "</br>" + "<a href='play.php?id=" + data.data_res['id'] +
						"&user=" + data.data_res['userid'] + "&name=" + data.data_res['name'] + "&category=" + data.data_res['cat'] +
						"'>Click this link to go to copied</a>");
				} else {
					//console.log('not undefined!');
	...
	<div style="clear:both;">
		<!-- Ezoic - Playbook - native_top -->
		<div id="ezoic-pub-ad-placeholder-111">
			<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
			<!-- Playbook Leader Responsive -->
			<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-2281684961690945" data-ad-slot="3206579751"
