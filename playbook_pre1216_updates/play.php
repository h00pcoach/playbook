...
<!DOCTYPE html>
	<head>
		...
		<title>
			<?php if($name!='') echo $name; ?> <?php if(isset($_GET['category'])) echo ' a '.$_GET['category'].' created on '; ?>
			Hoop Coach Playbook
		</title>
		...
		<meta property="og:title" content="<?php if($name!='') echo $name; ?><?php if(isset($_GET['category'])) echo ' a '.$_GET['category'].' created on '; ?>Hoop Coach Playbook"/>
		...
		<script src="js/acetrik1_test.js"></script>
...
//					      console.log('storeCanvas data: ', data);
				...
				<?php 
					...
					echo "$('#new_play_btn').click(function(){
	...
	<body>
			...
			<div class="container-fluid">
		    	...
		    	<div id="menu-nav" class="collapse navbar-collapse">
		      	<ul class="nav navbar-nav navbar-right">
		         	<li> 
		            	<a href="https://www.hoopcoach.org/playbook/basketball-plays.php" target= "_blank" style="color:black;">Plays Library</a> 
		          	</li>

		          	<li>
		            	<a href="https://www.hoopcoach.org/quick-tips-for-using-hoop-coach-playbook/" target= "_blank" style="color:black;">Quick Tips</a> 
		          	</li>

		          	<li>
		            	<a href="https://www.hoopcoach.org/hoop-coach-playbook-faqs/" rel="nofollow" style="color:black;">Help</a>
		          	</li>

		        	<li id="actions" class="dropdown"> 
		          		<div class="hidden-xs visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">
		          			<a id="menu-dd" data-target="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >Menu <span class="caret"></span></a>
			            	<ul class="dropdown-menu" aria-labelledby="menu-dd">
				                <li> 
				                  <a href="#" rel="nofollow" class="myplay">My Plays</a>
				                </li>
				                <li> 
				                ...
				                <li> 
				                  <a href="https://www.hoopcoach.org/playbook/play.php" rel="nofollow" style="color:black;" id="logout_btn">Logout</a> 
				                </li>
				           	</ul>
		          		</div>

		          		<div class="visible-xs-block">
				          	<a role="button" data-toggle="collapse" href="#collapseMenu" aria-expanded="false" aria-controls="collapseMenu">
				            	Menu
		          ...
		          <li id="logreglinks-container">
		            <div id="logreglinks" style="display:inline-block">
		              <a href="#" rel="nofollow" id="log">Login</a>
		              <span style="color: white">|</span>
		              <a href="https://www.hoopcoach.org/playbook/register.php?type=new" rel="nofollow" id="log">Register</a>
		            </div>
		          </li>
		      	</ul>
		    	</div>
		...
		<div class="container">
			...
			<div id="pdf_warning_dialog" title="Pro Membership Feature" style="display:none;"> 
				...
				<a href="/playbook/premium/index.php?uid=<?=$_SESSION['user_id']?>">Click here</a> to upgrade 
			</div>
			...
			<div class="row">
				<!-- TODO: UNCOMMENT BELOW BEFORE UPLOADING -->
		    ...
		    <div class="row game-row">
		    	...
		    	<div id="lrg"></div>
		      	...
		      	<div id="loading" class="center-block"> 
		      		<span id="loadtxt">Processing...</span>
		        	<div id="load">
		        		<img src="Model/Img/balls/ball01.png" style="left: 50%;margin-left: 0;"> <img src="Model/Img/balls/ball01.png" style="top: 50%;margin-top: -15px;left: 50%;margin-left: 25px;"> <img src="Model/Img/balls/ball01.png" style="bottom: 0px;left: 50%;margin-left: 0;"> <img src="Model/Img/balls/ball01.png" style="bottom: 0px;left: 50%;margin-left: -35px;"> <img src="Model/Img/balls/ball01.png" style="left: 50%;margin-left: -60px;top: 50%;margin-top: -15px;"> <img src="Model/Img/balls/ball01.png" style="left: 50%;margin-left: -35px;"> 
		        	</div>
		      	</div>
		      
		       	<div id="downloading" style="display:none;"> 
		       		<span id="loadtxt">Your play is being exported.</span>
		       		<div>
		       			<span id="loadtxt">Based on the size of the play this could take a minute</span>
		       		</div>
		      	...
		      	<div id="login" class="col-xs-12 col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
			    	<table width="100%">
			        	<tbody>
				            <tr>
				            ...
				            <tr>
				            	<td><a href="forgot_password.php" style="color:white; font-weight:bold;">Forgot Password?</a></td>
				            </tr>
				            <tr>
				              	<td style="padding: 0;">
		    	...
		    	<div id="plays"> 
		    		<img src="Model/Img/regBox/close_active.png" id="playClose" />
			        <table width="100%">
			          	<tbody>
				            <tr>
				              <th width="50%">Name</th>
			    ...
			    <div id="saveGame" class="col-xs-12 col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
			        <div>Save</div>
			        <div>
			        ...
			        <div style="text-align: center;">
			        	<img src="Model/Img/button/ok_active.jpg" id="saveg">
			        	<img src="Model/Img/button/cancel_active.jpg" id="cang">
			        </div>
			    </div>


			    <!-- <div class="col-xs-12 visible-xs-block" style="z-index: 50; padding: 0;">
			    	<a class="btn btn-hc pull-right tools-toggle" data-target=".tools">Tools</a>
			    </div> -->
			    ...
			    <!-- court -->
		      	...
		      	<div id="play-tools" class="col-xs-12 col-sm-6 tools">
		      		<div class="col-xs-12 tools-content center-block">
			        	...
			        	<!-- COURT SIZE -->
			        	<div class="col-sm-5 tools-section">
			            ...
			            <!-- offense -->
			            <div class="quickadd col-sm-offset-1 col-sm-6 tools-section">
			            ...
			            <!-- COURT OBJECTS -->
			            <div class="col-xs-12 tools-section">
				            ...
				            <div id="offense-container" class="col-xs-6 col-sm-6 col-md-3 tools-section"> 
				            	...
				            	<div class="btn-group" id="Player">
								  	...
								  	<ul class="dropdown-menu list-inline" style="text-align:center;">
								    	<li> <img src="Model/Img/players/01.png" id="p1" class="ui-draggable clickable tool" data-target=".tools" data-x="125" data-y="353" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/02.png" id="p2" class="ui-draggable clickable tool" data-target=".tools" data-x="84" data-y="421" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/03.png" id="p3" class="ui-draggable clickable tool" data-target=".tools" data-x="186" data-y="410" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/04.png" id="p4" class="ui-draggable clickable tool" data-target=".tools" data-x="108" data-y="460" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/05.png" id="p5" class="ui-draggable clickable tool" data-target=".tools" data-x="176" data-y="463" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/06.png" id="p6" class="ui-draggable clickable tool" data-target=".tools" data-x="125" data-y="353" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/07.png" id="p7" class="ui-draggable clickable tool" data-target=".tools" data-x="84" data-y="421" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/08.png" id="p8" class="ui-draggable clickable tool" data-target=".tools" data-x="186" data-y="410" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/09.png" id="p9" class="ui-draggable clickable tool" data-target=".tools" data-x="108" data-y="460" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/10.png" id="p10" class="ui-draggable clickable tool" data-target=".tools" data-x="176" data-y="463" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/11.png" id="p11" class="ui-draggable clickable tool" data-target=".tools" data-x="125" data-y="353" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/12.png" id="p12" class="ui-draggable clickable tool" data-target=".tools" data-x="84" data-y="421" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/13.png" id="p13" class="ui-draggable clickable tool" data-target=".tools" data-x="186" data-y="410" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/14.png" id="p14" class="ui-draggable clickable tool" data-target=".tools" data-x="108" data-y="460" alt="Basketball Playbook Offense"> </li>
					                    <li> <img src="Model/Img/players/15.png" id="p15" class="ui-draggable clickable tool" data-target=".tools" data-x="176" data-y="463" alt="Basketball Playbook Offense"> </li>
								  	</ul>
								</div>				        
				            ...
				            <div id="defense-container" class="col-xs-6 col-sm-6 col-md-3 tools-section">
				            	...
				            	<div class="btn-group" id="Forward">
								  	...
								  	<ul class="dropdown-menu list-inline" style="text-align:center;">
								    	<li> <img src="Model/Img/forwards/x1.png" id="x1" class="ui-draggable clickable tool" data-target=".tools" data-x="82" data-y="90" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x2.png" id="x2" class="ui-draggable clickable tool" data-target=".tools" data-x="90" data-y="82" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x3.png" id="x3" class="ui-draggable clickable tool" data-target=".tools" data-x="166" data-y="155" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x4.png" id="x4" class="ui-draggable clickable tool" data-target=".tools" data-x="240" data-y="169" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x5.png" id="x5" class="ui-draggable clickable tool" data-target=".tools" data-x="169" data-y="240" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x6.png" id="x6" class="ui-draggable clickable tool" data-target=".tools" data-x="82" data-y="90" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x7.png" id="x7" class="ui-draggable clickable tool" data-target=".tools" data-x="90" data-y="82" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x8.png" id="x8" class="ui-draggable clickable tool" data-target=".tools" data-x="166" data-y="155" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x9.png" id="x9" class="ui-draggable clickable tool" data-target=".tools" data-x="240" data-y="169" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x10.png" id="x10" class="ui-draggable clickable tool" data-target=".tools" data-x="169" data-y="240" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x11.png" id="x11" class="ui-draggable clickable tool" data-target=".tools" data-x="82" data-y="90" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x12.png" id="x12" class="ui-draggable clickable tool" data-target=".tools" data-x="90" data-y="82" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x13.png" id="x13" class="ui-draggable clickable tool" data-target=".tools" data-x="166" data-y="155" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x14.png" id="x14" class="ui-draggable clickable tool" data-target=".tools" data-x="240" data-y="169" alt="Basketball Playbook Defense"> </li>
					                    <li> <img src="Model/Img/forwards/x15.png" id="x15" class="ui-draggable clickable tool" data-target=".tools" data-x="169" data-y="240" alt="Basketball Playbook Defense"> </li>
								  	</ul>
								</div>
				            ...
				            <div id="ball-container" class="col-xs-6 col-sm-6 col-md-3 tools-section">
								...
								<div class="btn-group" id="Ball">
								  	...
								  	<ul class="dropdown-menu list-inline" style="text-align:center;">
										<li> <img src="Model/Img/balls/ball01.png" id="b0" class="ui-draggable ui-draggable-handle clickable tool" /> </li>
						                <li> <img src="Model/Img/balls/ball02.png" id="b1" class="ui-draggable ui-draggable-handle clickable tool" /> </li>
								  	</ul>
								</div>
				            ...
				            <div id="cone-container" class="col-xs-6 col-sm-6 col-md-3 tools-section">
				            	...
				            	<div class="btn-group" id="Cone">
								  	...
								  	<ul class="dropdown-menu list-inline" style="text-align:center;">
										<li> <img src="Model/Img/forwards/cone01.png" id="c1" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone02.png" id="c2" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone03.png" id="c3" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone04.png" id="c4" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone05.png" id="c5" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone06.png" id="c6" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone07.png" id="c7" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone08.png" id="c8" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone09.png" id="c9" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone10.png" id="c10" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone11.png" id="c11" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone12.png" id="c12" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone13.png" id="c13" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone14.png" id="c14" class="ui-draggable clickable tool" data-target=".tools" /> </li>
					                    <li> <img src="Model/Img/forwards/cone15.png" id="c15" class="ui-draggable clickable tool" data-target=".tools" /> </li>
								  	</ul>
								</div>				             
				            </div>
						...
						<!-- MOVEMENT OPTIONS -->
				        <div id="record" class="col-xs-12 col-sm-5 tools-section">
				        	<h2><strong>Movement Options</strong></h2>
				          	...
				          	<ul class="list-inline" style="text-align: center;">
					            ...
					            <li class="tool" data-target=".tools">
					              	<button id="add_movement" class="btn btn-default btn-pb btn-lg center-block">
				        ...
				        <!-- ANIMATION CONTROLS -->
			        	<div id="controls" class="col-sm-offset-1 col-sm-6 tools-section">
						...
						<!-- DRAWING TOOLS -->
				        <div class="col-sm-5 tools-section hidden-xs">
				        ...
				        <!-- PLAY MANAGEMENT -->
				        <div class="col-xs-12 col-sm-offset-1 col-sm-6 tools-section">
				        	...
				        	<ul class="list-inline" style="text-align: center;">
				        		...
				        		<li>
				        			<a href="play.php" id="new_play_btn" class="tool btn btn-default btn-pb btn-lg center-block" data-target=".tools" style="font-size: 18px;"> 
					        			<span class="glyphicon glyphicon-plus"></span>
				        			</a>
				        			new
				        		</li>
				        		<?php if(!$is_student): ?>
				              		<li class="tool" data-target=".tools">
				                		<button href="play.php" id="save_btn" class="tool btn btn-default btn-pb btn-lg center-block" data-target=".tools"> 
...
//			console.log('visited cookie: ', cookie);
//	    });
	</script>
	<script>
...
//			console.log('tools has class showing? ', $(tools).hasClass('showing'));
...
//		$('.ui-draggable').draggable(function() 
//		{	
