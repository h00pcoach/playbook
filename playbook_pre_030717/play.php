			...
			<div class="container-fluid">
		    	...
		    	<div id="menu-nav" class="collapse navbar-collapse">
		      	<ul class="nav navbar-nav navbar-right">
		         	<li> 
		            	<a class="nav-link" href="https://www.hoopcoach.org/playbook/basketball-plays.php" target= "_blank" style="color:black;">Plays Library</a> 
		          	</li>
				...
				<div id="downloading-modal" class="modal" tabindex="-1" role="dialog">
				  	<div class="modal-dialog" role="document">
				    	<div class="modal-content">
				      		...
				      		<div class="modal-body">
				        		<h4 style="text-align: center;">Your play is being exported. <br /> Based on the size of the play this could take a minute. <br /> <span class="glyphicon glyphicon-refresh glyphicon-refresh-animate"></span></h4>
				      		</div>
	      		    	...
	      		    	<div class="modal-content">
	      		      		...
	      		      		<div class="modal-body">
	      		        		...
	      		        		<div class="form-group">
	      		        			...
	      		        			<a id="forgot_pass" class="pull-right" href="forgot_password.php">forgot password?</a>
						                    	...
						                    	<td width="50%" style="vertical-align: middle;"><?php echo $currentPlay['name']; ?></td>
						                      	<td data-play="<?php echo $currentPlay['id']; ?>" data-path="<?php echo $currentPlay['file']; ?>">
						                      		...
						                      		<button class="btn btn-default btn-pb" onClick="remPlay(this)">
						                      			<span class="glyphicon glyphicon-trash" style="color: red" onClick="remPlay(this)"></span>
						                      		</button>
				  	...
				  	<div class="modal-dialog" role="document">
				    	<div class="modal-content">
				      		...
				      		<div class="modal-body">
						         ...
						         <div class="form-group">
						          	<select id="cat" size="9" class="form-control">
							            <?php
