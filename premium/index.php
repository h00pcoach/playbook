...
<body>
  ...
  <nav id="nav">
    <ul class="container">
      <li><a href="http://hoopcoach.org/playbook/blog/wp-content/uploads/2014/08/Pick-and-Roll-motion-offense.pdf">PDF
          Demo</a></li>
      <li><a href="https://docs.google.com/document/d/1SEBDNNozg8mcicFeR6EZUE-iGukZvQYhT1gZy2VlkNE/pub">Using the
          Playbook </a></li>
    ...
    <article class="container" id="top">
      <div class="row">
        ...
        <div class="8u">
          ...
          <ul>
            <b>
              <li>Save plays directly to your devices for easy texting or offline viewing - <a href="http://www.hoopcoach.org/wp-content/uploads/2015/07/Michigan-State-Man-Set.gif">see
                  example</a>
            ...
            <br>
            <h3>
              <font color="#000099">Save Gym Time. Teach your Players at Home.</font>
            </h3>
          </ul>
          <h5>$
            <?= $settings['monthly_amount'] ?>/month or $
            <?= $settings['yearly_amount'] ?> per year - <i>(Paypal or Debit/Credit)</i></h5>
          <div>
            Choose Payment Plan:
            <input type="radio" name="payment_type" value="yearly" checked>Yearly
            <input type="radio" name="payment_type" value="monthly">Monthly
          </div>
          <a id="upgrade-btn" href="https://hoopcoach.org/playbook/pay/pay_index.php?uid=<?= $uid ?>&affiliate=<?= $affiliate ?>&payment_type=yearly"
            id="submit-button" class="button big scrolly">Upgrade Now</a>
          <br>
          <div>
  ...
  <script type="text/javascript">
    $(function() {
      $("input[name='payment_type']").click(function() {
        ...
        $('#upgrade-btn').attr("href",
          `https://hoopcoach.org/playbook/pay/pay_index.php?uid=<?= $uid ?>&affiliate=<?= $affiliate ?>&payment_type=${pay_type}`
        );
      });
    })
  </script>
